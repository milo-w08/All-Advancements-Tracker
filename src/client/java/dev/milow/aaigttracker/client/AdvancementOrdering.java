...
final class AdvancementOrdering {
    static final Comparator<AdvancementSnapshot> SNAPSHOT_ORDER = Comparator
    ...
    static List<String> orderCriteria(Identifier advancementId, List<String> criteria) {
